...
```
git clone https://github.com/rsurfings/react-onboarding.git
```

### Build the image and fire up the container development envirolment:

```
docker-compose up -d --build
```

### Build the image and fire up the container production envirolment:

```
docker build -f Dockerfile.prod -t react-onboarding:prod .
```
...
You can learn more in [this tutorial](https://www.newline.co/fullstack-react/articles/using-create-react-app-with-a-server/).
